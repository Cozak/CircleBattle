...
class BuildExe:
    def __init__(self):
        ...
        # 起始py文件
        self.script = "CoMain.py"
        # 游戏名
        self.project_name = "Circle-Battle"
        # 游戏site
        self.project_url = "about:none"
        # 游戏版本
        self.project_version = "0.41"
        # 游戏许可
        self.license = "Circle-Battle License"
        # 游戏作者
        self.author_name = "Cozak"
        # 联系电邮
        self.author_email = "sscozak@163.com"
        # 游戏版权
        self.copyright = "Copyright (c) 2020 Cozak."
        # 游戏描述
        self.project_description = "This is a Prototype with a test game pass"
        # 游戏图标(None的话使用pygame的默认图标)
        self.icon_file = None
        # 额外需要拷贝的文件、文件夹(图片，音频等)
        self.extra_datas = ['img', 'GamePass.py']
        # 额外需要的python库名
        ...
        self.exclude_dll = []
        # 需要加入的py文件
        self.extra_scripts = ['CoControllerM',
                             'CoDataCollector',
                             'CoEntityBase',
                             'CoEntityBullet',
                             'CoEntityDiedBody',
